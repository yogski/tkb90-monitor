...
INSERT INTO "tkb90_p2p_provider" ("description", "full_path", "http_body", "http_header", "http_method", "source_name", "source_type", "is_active") values ('estakapital.co.id', 'https://www.estakapital.co.id', NULL, NULL, 'GET', 'estakapital', 'web', false);