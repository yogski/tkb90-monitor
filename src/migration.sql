...
INSERT INTO "tkb90_p2p_provider" ("description", "full_path", "http_body", "http_header", "http_method", "source_name", "source_type") values ('pinjamwinwin.com', 'https://pinjamwinwin.com/risk/report/official-statistic', NULL, NULL, 'GET', 'pinjamwinwin', 'api');
INSERT INTO "tkb90_p2p_provider" ("description", "full_path", "http_body", "http_header", "http_method", "source_name", "source_type") values ('klika2c.co.id', 'https://clickacc.com/api-frontend-a2c/api', NULL, NULL, 'GET', 'klika2c', 'api-klika2c');
INSERT INTO "tkb90_p2p_provider" ("description", "full_path", "http_body", "http_header", "http_method", "source_name", "source_type") values ('cicil.co.id', 'https://api.cicil.co.id/v1/report/statistics', NULL, NULL, 'GET','cicil', 'api');
INSERT INTO "tkb90_p2p_provider" ("description", "full_path", "http_body", "http_header", "http_method", "source_name", "source_type") values ('danasyariah.id', 'https://www.danasyariah.id', NULL, NULL, 'GET', 'danasyariah', 'web');
INSERT INTO "tkb90_p2p_provider" ("description", "full_path", "http_body", "http_header", "http_method", "source_name", "source_type") values ('pinjamduit.co.id', 'https://api.pinjamduit.co.id/gw/loan/credit-app/tkb90?deviceId=WEB&clientType=web&appMarket=web&appVersion=99.99.99', NULL, NULL, 'GET', 'pinjamduit', 'api');